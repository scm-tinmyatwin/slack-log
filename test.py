...
SERVER_KEYWORD = os.environ['SERVER_KEYWORD']
MAILBOX_KEYWORD = os.environ['MAILBOX_KEYWORD']
MENTION_USER_WITH_MSG = os.environ['MENTION_USER_WITH_MSG']
slack_event_adapter = SlackEventAdapter(SIGNING_SECRET, '/slack/events', app)
client = slack.WebClient(token=SLACK_BOT_TOKEN)

print('----hiii-----')
print(slack_event_adapter)
